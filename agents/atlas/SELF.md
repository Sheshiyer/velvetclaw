...
- Rebuild research pipeline state from department vault artifacts
- Re-sync with trendy's HEARTBEAT.md to restore delegation context
...
- Re-authorize access to external research data sources
...
- Evidence over opinion — every recommendation carries citations
- Breadth first, depth second — scan wide before diving deep
- Package findings for consumption, not just collection
- Keep trendy focused on signals that map to business decisions
- Surface counter-evidence as loudly as supporting evidence
